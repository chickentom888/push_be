...
class ERC20Converter
{
	...
	private function getValueOfUnit($unit = 'ether')
	{
	...
	private function getDivisionScale($amount, $unit)
	{
		if (!isset($this->unitMap[$unit])) {
			$this->throwExceptionForUnit($unit);
		}
	...
	private function throwExceptionForUnit($unit)
	{
