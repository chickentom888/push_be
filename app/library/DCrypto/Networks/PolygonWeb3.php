 ...
 */
class PolygonWeb3 extends ICoin
{
    const MAIN_CURRENCY = 'matic';
    ...
    function __construct($token, $network = null)
    {
        ...
        $this->explorer_link = parent::$explorerPEP20Link[$network ?? ContractLibrary::MAIN_NETWORK];
        if (strlen($network)) {
    ...
    public function getCoinInfo()
    {
        ...
        $coinInfo->hosts = [
            'main' => [
                [
                    "host" => $config->blockchain['polygon_rpc_main_net'],
                    "port" => '',
                    'username' => '',
                    'password' => '',
                    "passphrase" => "",
            ...
            'test' => [
                [
                    "host" => $config->blockchain['polygon_rpc_test_net'],
                    "port" => '',
                    'username' => '',
                    'password' => '',
                    "passphrase" => "",
