 ...
 */
class EthereumWeb3 extends ICoin
{
    const MAIN_CURRENCY = 'eth';
    const PLATFORM = 'eth';
    ...
    function __construct($token, $network = null)
    {
        ...
        $this->explorer_link = parent::$explorerERC20Link[$network ?? ContractLibrary::MAIN_NETWORK];
        if (strlen($network)) {
    ...
    public function getCoinInfo()
    {
        ...
        $coinInfo->hosts = [
            'main' => [
                [
                    "host" => $config->blockchain['eth_rpc_main_net'],
                    "port" => '',
                    'username' => '',
                    'password' => '',
                    "passphrase" => "",
            ...
            'test' => [
                [
                    "host" => $config->blockchain['eth_rpc_test_net'],
                    "port" => '',
                    'username' => '',
                    'password' => '',
                    "passphrase" => "",
    ...
    public function getBlockchainInfo()
    {
        try {
            ...
            foreach ($listHost as $hostInstance) {
                ...
                $sync = [];
                $eth->syncing(function ($err, $res) use (&$sync) {
                    if ($res) {
                        $sync = $res;
                    }
                });
