    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                <h4 class="page-title">Create Presale </h4>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-12 col-xl-12 col-sm-12">
            ...
            <div class="card bg-white m-b-30">
                ...
                <div class="card-body">
                    ...
                    <h5 class="header-title mb-4 mt-0">Create Presale</h5>
                        ...
                        <form role="form" method="post" action="">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label for="presale-generator-address">Presale Generator</label>
                                        <input class="form-control" type="text" value="" id="presale-generator-address" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label for="presale_creator">Presale creator</label>
                                        <input class="form-control" type="text" name="presale_creator" value="" id="presale_creator" readonly>
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label for="amount">How many <span class="sale_token_symbol"></span> are up for presale?</label>
                                    ...
                                    <div class="form-group">
                                        <label for="presale_rate">Presale Rate (1 <span class="base_token_symbol"></span> = ? <span class="sale_token_symbol"></span>)</label>
                                        <input class="form-control" type="text" name="presale_rate" value="" id="presale_rate" readonly>
                                    </div>

                                    <div class="form-group">
                                        <label for="listing_rate_percent">Listing Rate Percent (%)</label>
                                        <select name="listing_rate_percent" class="form-control" id="listing_rate_percent">
                                    ...
                                    <div class="form-group">
                                        <label for="listing_rate">Listing Rate (1 <span class="base_token_symbol"></span> = ? <span class="sale_token_symbol"></span>)</label>
                                        <input class="form-control" type="text" name="listing_rate" value="" id="listing_rate" readonly>
                                    </div>

                                    <div class="form-group">
                                        <label for="liquidity_percent">Liquidity Percent (%)</label>
                                        <input class="form-control" type="text" name="liquidity_percent" value="" id="liquidity_percent">
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label for="base_amount_predict">Presale prediction (<span class="base_token_symbol"></span>)</label>
                                    ...
                                    <div class="form-group">
                                        <label for="base_token_liquidity_predict"><span class="base_token_symbol"></span> Liquidity</label>
                                        <input class="form-control" type="text" name="base_token_liquidity_predict" value="" id="base_token_liquidity_predict" readonly>
                                    </div>

                                    <div class="form-group">
                                        <label for="sale_token_liquidity_predict"><span class="sale_token_symbol"></span> Liquidity</label>
                                        <input class="form-control" type="text" name="sale_token_liquidity_predict" value="" id="sale_token_liquidity_predict" readonly>
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label for="lock_liquid_for">Lock liquid for</label>
                                        <select name="listing_rate_percent" class="form-control" id="lock_liquid_for">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label for="sale_token_for_liquidity"><span class="sale_token_symbol"></span> for liquidity</label>
                                        <input class="form-control" type="text" name="sale_token_for_liquidity" value="" id="sale_token_for_liquidity" readonly>
                                    </div>
                            ...
                            <button type="button" class="btn btn-success" id="btn_create_presale">Create</button>
...
<script type="text/javascript">
    ...
    function calculateAmount() {
        ...
        if (hardCap <= 0) {
            $('#presale_rate, #listing_rate').val(0);
            return;
        }
        let presaleRate = saleTokenAmount / hardCap;
        $('#presale_rate').val(presaleRate);
        let listingRatePercent = parseFloat($('#listing_rate_percent').val());
        let listingRate = presaleRate - (presaleRate / 100 * listingRatePercent);
        $('#listing_rate').val(listingRate);

        let baseTokenFeeInput = $('#base_token_fee');
        let saleTokenFeeInput = $('#sale_token_fee');

        let liquidityPercent = parseFloat($('#liquidity_percent').val() || 0);
        ...
        let saleTokenSoldPredict = baseAmountPredict * presaleRate;
        ...
        let baseTokenLiquidAmountPredict = baseAmountPredictAfterFee / 100 * liquidityPercent;
        let saleTokenLiquidAmountPredict = (baseAmountPredict - (baseAmountPredict / 100 * baseFeePercent)) / 100 * liquidityPercent * listingRate;
        baseTokenFeeInput.val(baseTokenFeePredict);
        saleTokenFeeInput.val(saleTokenFeePredict);
        $('#base_token_liquidity_predict').val(baseTokenLiquidAmountPredict);
        $('#sale_token_liquidity_predict').val(saleTokenLiquidAmountPredict);
        let baseTokenOwnerPredict = baseAmountPredictAfterFee - baseTokenLiquidAmountPredict;
        ...
        let hardCapAfterFee = hardCap - baseFeeAmount;
        let baseAmountForLiquid = hardCapAfterFee / 100 * liquidityPercent;
        let saleTokenLiquidAmount = baseAmountForLiquid * listingRate;

        let maxSaleTokenAmountForFee = saleTokenAmount / 100 * tokenFeePercent;
        let maxSaleTokenAmountRequired = saleTokenAmount + maxSaleTokenAmountForFee + saleTokenLiquidAmount;

        $('#sale_token_required').val(maxSaleTokenAmountRequired);
        $('#sale_token_for_sale').val(saleTokenAmount);
        $('#sale_token_for_liquidity').val(saleTokenLiquidAmount);
    ...
    async function approveToken() {
        ...
        let presaleGeneratorAddress = $('#presale-generator-address').val();
        if (!presaleGeneratorAddress.length) {
            toastr["error"]("Presale Generator Not Found");
            return;
        }
        ...
        let approve = await tokenContract.methods.approve(presaleGeneratorAddress, saleTokenRequired).send({
    ...
    async function createPresale() {
        try {
            ...
            let tokenPrice = parseFloat($('#presale_rate').val());
            ...
            let liquidityPercent = parseInt(parseFloat($('#liquidity_percent').val()) * 10);

            let listingPrice = parseFloat($('#listing_rate').val());
            listingPrice = (new BigNumber(listingPrice)).mul((new BigNumber(10)).pow(saleTokenDecimals));
            listingPrice = web3.utils.toBN(listingPrice).toString();
            ...
            let lockPeriod = parseInt($('#lock_liquid_for').val());
            lockPeriod = 60 * 60 * 24 * 30 * lockPeriod;
            ...
            let presaleGeneratorContract = new web3.eth.Contract(ABI_PRESALE_GENERATOR, presaleGeneratorAddress);
            let approve = await presaleGeneratorContract.methods.createPresale(selectedAccount, saleTokenAddress, baseTokenAddress, activeInfo, params, listVestingPeriod, listVestingPercent).send({
                from: selectedAccount,
                value: creationFee
            }).on('transactionHash', function (hash) {
                alert("Please wait a minute to complete your transaction!");
    ...
    function getConfigAddress(type = 'presale_generator') {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.data) {
                    $('#presale-generator-address').val(data.data.address);
                } else {
                    $('#presale-generator-address').val('');
                }
            },
            done: function () {
            }
    ...
    $(document).ready(function () {
        ...
        $('#amount, #hard_cap, #listing_rate_percent, #liquidity_percent, #base_amount_predict, #base_amount_per_user').on('change', calculateAmount);

        $('#btn_approve').on('click', approveToken);

        $('#btn_create_presale').on('click', createPresale);
