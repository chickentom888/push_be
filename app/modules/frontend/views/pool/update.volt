    ...
    <div class="row">
        <div class="col-md-12 col-xl-12 col-sm-12">
            ...
            <div class="card bg-white m-b-30">
                <div class="card-body">
                    <h5 class="header-title mb-4 mt-0">Update Pool Name</h5>
                    {% if presale %}
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="pool_token_name">Pool Name</label>
                                            <input class="form-control" type="text" name="pool_token_name"
                                                   value="{{ presale['pool_token_name'] }}"
                                                   id="pool_token_name">
                                        </div>
                                        <div class="form-group">
                                            <label for="pool_token_address">Sale Token Address</label>
                                            <a class="form-control" readonly
                                               href="{{ helper.getLinkAddress(presale['pool_token_address'], presale['platform'], presale['network']) }}"
                                               target="_blank"><b>{{ presale['pool_token_address'] }}</b></a>
                                        </div>

                                        <div class="form-group">
                                            <label for="pool_token_symbol">Sale token symbol</label>
                                            <input class="form-control" type="text" name="pool_token_symbol"
                                                   value="{{ presale['pool_token_symbol'] }}"
                                                   id="pool_token_symbol" readonly>
                                        </div>

                                        <div class="form-group">
                                            <label for="pool_token_decimals">Sale token decimals</label>
                                            <input class="form-control" type="text" name="pool_token_decimals"
                                                   value="{{ presale['pool_token_decimals'] }}" id="pool_token_decimals"
                                                   readonly>
                                        </div>
                                    </div>
