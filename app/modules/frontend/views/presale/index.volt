        ...
        <div class="col-md-12 col-xl-12 col-sm-12">
            <div class="card bg-white m-b-30">
                <div class="card-body new-user">
                    ...
                    <h5 class="header-title mb-4 mt-0">List Presale</h5>
                    ...
                    <form action="" class="form settings-form" method="get">
                        <div class="row">
                            ...
                            <div class="col-sm-2 form-group">
                                <label for="presale-status">Status</label>
                            ...
                            <div class="col-sm-2 form-group">
                                ...
                                <select name="sale_type" id="sale_type" class="form-control">
                                    <option value="">Select</option>
                                    <option value="ilo" {{ dataGet['sale_type'] == 'ilo' ? 'selected' : '' }}>ILO</option>
                                    <option value="ilov" {{ dataGet['sale_type'] == 'ilov' ? 'selected' : '' }}>ILOV</option>
                                </select>
                            </div>
                            ...
                            {% for item in listData %}
                                <tr>
                                    <td>
                                        ...
                                        <div>Sale type: <b>{{ item['sale_type'] ? item['sale_type']|upper : 'ILO' }}</b></div>
                                    </td>
                                    <td>
                                        <div>
                                    ...
                                    <td>
                                        ...
                                        <div>Sale Token Liquidity: <b>{{ helper.numberFormat(item['sale_token_liquidity_amount'], 4) }}</b></div>
                                    ...
                                    <td>
                                        ...
                                        <div>Base liquidity amount: <b>{{ helper.numberFormat(item['base_token_liquidity_amount'], 4) }}</b></div>

                                    </td>

                                    <td>
                                        <div>Sale Price: <b>{{ helper.numberFormat(item['token_price'], 4) }}</b></div>
                                        <div>Listing Price: <b>{{ helper.numberFormat(item['listing_price'], 4) }}</b></div>
                                        <div>Listing Price Percent: <b>{{ helper.numberFormat(item['listing_price_percent'], 4) }}</b></div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div>
                                            <a class="btn btn-info btn-sm" href="/presale/detail/{{ item['_id'] }}">Detail</a>
                                            <a class="btn btn-info btn-sm" href="/presale/update/{{ item['_id'] }}">Update</a>
                                        </div>
                                        <div class="mt-2">
                                            <a class="btn btn-success btn-sm" href="/presale/buy_log/{{ item['_id'] }}">Buy Log</a>
                                            <a class="btn btn-success btn-sm" href="/presale/user_log/{{ item['_id'] }}">User Log</a>
                                        </div>
                                        <div class="mt-2">
                                            <a class="btn btn-success btn-sm" href="/presale/user_zero_round/{{ item['_id'] }}">User Zero Round</a>
                                            <a class="btn btn-success btn-sm" href="/presale/whitelist_user/{{ item['_id'] }}">Whitelist User</a>
                                        </div>
                                        <div class="mt-2">
