    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                <h4 class="page-title">User Package Interest</h4>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="col-md-12 col-xl-12 col-sm-12">
            <div class="card bg-white m-b-30">
                <div class="card-body new-user">
                    <h5 class="header-title mb-4 mt-0">User Package Interest</h5>
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    ...
                                    <select name="type" id="type" class="form-control">
                                        ...
                                        <option value="staking_interest" {{ (dataGet['type']|length AND dataGet['type'] == 'staking_interest') ? 'selected' : '' }}>Daily interest</option>
                                        <option value="staking_fund_interest" {{ (dataGet['type']|length AND dataGet['type'] == 'staking_fund_interest') ? 'selected' : '' }}>Fund interest</option>
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="row mt-2">
                        <div class="col-sm-12">
                            <div>Total: <b>{{ helper.numberFormat(summaryData['real_amount'], 2) }}</b></div>
                        </div>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover mb-0">
                            ...
                            <tr>
                                ...
                                <th class="border-top-0">Package Amount</th>
                                <th class="border-top-0">Amount</th>
                                <th class="border-top-0">Day/Times</th>
                            ...
                            {% for item in listData %}
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>Amount: <b>{{ helper.numberFormat(item['user_package_amount'], 2) }}</b></div>
                                        <div>Percent: <b>{{ item['bonus_percent'] }}</b></div>
                                    </td>
                                    <td>{{ helper.numberFormat(item['real_amount'], 2) }}</td>
                                    <td>{{ item['interest_day'] ? item['interest_day'] : item['fund_interest_times'] }}</td>
                                    <td><b>{{ item['type'] == 'staking_interest' ? 'Daily Interest' : 'Fund Interest' }}</b></td>
