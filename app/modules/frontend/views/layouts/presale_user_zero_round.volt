        ...
        <div class="col-md-12 col-xl-12 col-sm-12">
            <div class="card bg-white m-b-30">
                <div class="card-body new-user">
                    <h5 class="header-title mb-4 mt-0">Presale User Zero Round </h5>

                    {% if isSearch == true %}
                        <form action="" class="form settings-form" method="get">
                            <div class="row">
                                <div class="col-sm-2">
                                    <input placeholder="Address" id="user_address" type="text" class="form-control" name="q"
                                           value="{{ dataGet['q'] }}">
                                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover mb-0">
                            ...
                            {% for item in listPresaleUserZeroRound %}
                                <tr>
                                    <td>
