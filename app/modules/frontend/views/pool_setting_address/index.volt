        ...
        <div class="col-md-12 col-xl-12 col-sm-12">
            <div class="card bg-white m-b-30">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            {% for key,item in listPoolSettingAddressType %}
                                <a href="/pool_setting_address/index/{{ key }}" class="btn btn-{{ type == key ? 'info' : 'outline-dark' }}">{{ item }}</a>
                            {% endfor %}
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            {% for item in listData %}
                                <tr>
                                    ...
                                    <td>
                                        <a href="/pool_setting_address/form/{{ item['_id'] }}" class="btn btn-info btn-sm">Update</a>
                                    </td>
                                </tr>
                            {% endfor %}
