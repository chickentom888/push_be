    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                <h4 class="page-title">Sale Setting Address</h4>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-12 col-xl-12 col-sm-12">
            <div class="card bg-white m-b-30">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            {% for key,item in listSaleSettingAddressType %}
                                <a href="/sale_setting_address/index/{{ key }}" class="btn btn-{{ type == key ? 'info' : 'outline-dark' }}">{{ item }}</a>
                            {% endfor %}
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            {% for item in listData %}
                                <tr>
                                    ...
                                    <td>
                                        <a href="/sale_setting_address/form/{{ item['_id'] }}" class="btn btn-info btn-sm">Update</a>
                                    </td>
                                </tr>
                            {% endfor %}
