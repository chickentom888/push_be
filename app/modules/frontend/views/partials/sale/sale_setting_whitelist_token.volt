        ...
        <div class="card bg-white m-b-30">
            <div class="card-body">
                ...
                <div class="general-label">
                    ...
                    {% if setting['whitelist_token']['address_number'] > 0 %}
                        {% for key, item in setting['whitelist_token']['list_address'] %}

                            <div class="row whitelist-token-info">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="whitelist-token-address-{{ key }}">Token address</label>
                                        <a href="{{ helper.getLinkAddress(item['token_address'], platform, network ) }}" target="_blank" class="form-control whitelist-token-address">{{ item['token_address'] }}</a>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" value="{{ item['token_name'] }}" id="whitelist-token-name-{{ key }}" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" value="{{ item['token_symbol'] }}" id="whitelist-token-symbol-{{ key }}" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control whitelist-token-decimals" type="text" value="{{ item['token_decimals'] }}" id="whitelist-token-decimals-{{ key }}" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control whitelist-token-amount" type="text" value="{{ item['token_amount'] }}" id="whitelist-token-amount-{{ key }}">
                                    </div>
                                </div>
