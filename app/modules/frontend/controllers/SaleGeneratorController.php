...
class SaleGeneratorController extends ExtendedControllerBase
{
    ...
    public function indexAction()
    {
        ...
        $listData = $saleGeneratorCollection->find($conditions, $options);
        !empty($listData) && $listData = $listData->toArray();
        $count = $saleGeneratorCollection->countDocuments($conditions);
