...
class PresaleGeneratorController extends ExtendedControllerBase
{
    ...
    public function indexAction()
    {
        ...
        $listData = $presaleGeneratorCollection->find($conditions, $options);
        !empty($listData) && $listData = $listData->toArray();
        $count = $presaleGeneratorCollection->countDocuments($conditions);
